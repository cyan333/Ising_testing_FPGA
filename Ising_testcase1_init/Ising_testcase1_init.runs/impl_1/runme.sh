...
HD_PWD='E:/Shanshan_Xie/1-Ising_2021/1-Test/FPGA/codeFromHome/Ising_testcase1_init/Ising_testcase1_init.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testcase2_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testcase2_main.tcl -notrace
