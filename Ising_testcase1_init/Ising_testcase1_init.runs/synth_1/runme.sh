...
HD_PWD='E:/Shanshan_Xie/1-Ising_2021/1-Test/FPGA/codeFromHome/Ising_testcase1_init/Ising_testcase1_init.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testcase2_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testcase2_main.tcl
