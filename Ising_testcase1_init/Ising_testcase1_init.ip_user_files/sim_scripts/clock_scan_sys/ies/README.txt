...
#
# Generated by export_simulation on Fri Aug 13 18:47:30 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './clock_scan_sys.sh' script.

./clock_scan_sys.sh -reset_run
...
./clock_scan_sys.sh -noclean_files

For more information on the script, please type './clock_scan_sys.sh -help'.
